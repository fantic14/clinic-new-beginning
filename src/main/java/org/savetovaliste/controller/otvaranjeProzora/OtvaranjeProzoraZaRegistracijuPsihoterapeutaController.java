...
public class OtvaranjeProzoraZaRegistracijuPsihoterapeutaController implements EventHandler<ActionEvent> {
    @Override
    public void handle(ActionEvent actionEvent) {
        ...
        try{
            ...
            throw new RuntimeException("Error starting RegistracijaPsihoterapeutaWindow", e);
        }
    }
}
