...
import org.savetovaliste.view.prikazi.PregledBuducihSeansi;
import org.savetovaliste.view.prikazi.PregledSeansi;

public class OtvaranjeProzoraZaBuduceSeanse implements EventHandler<ActionEvent>{
    ...
    public void handle(ActionEvent actionEvent) {
        try {
            if (LogovanjePsihoterapeutaController.logedIn) {
                ...
                PregledBuducihSeansi window = new PregledBuducihSeansi(p.getPsihoterapeutId());
            ...
            throw new RuntimeException("Error starting Otvaranje Buducih Seansi prozora", e);
        }
    }
}
